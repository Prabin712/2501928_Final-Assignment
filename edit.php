...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update->execute([$_POST['name'], $_POST['type'], floatval($_POST['price']), $id]);
...
<form method="post">
    ...
    Price per Day: <input type="number" name="price" step="0.01" value="<?= escape($vehicle['price_per_day']) ?>" required><br><br>
